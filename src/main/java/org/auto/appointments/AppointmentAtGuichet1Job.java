...
public class AppointmentAtGuichet1Job implements Job {
    ...
    public static String guichetId1 = "planning31299";
    public static String guichetId2 = "planning31616";

    public static String guichetName1 = "GUICHET A";
    public static String guichetName2 = "GUICHET B";
    ...
    private static void excecuteAppointment(WebDriver driver, String guichetName, String guichetId) {
        ...
        try {
            ...
            driver.get("https://www.essonne.gouv.fr/booking/create/31298/1");
        ...
        catch (NoSuchElementException | InterruptedException ex ) { // | IOException ex
